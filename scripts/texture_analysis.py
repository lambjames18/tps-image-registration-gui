"""Law's texture energy analysis (exploratory script).

This is a research helper, not part of the ``tpsreg`` package. The dataset
paths below are local to the original author's machine and must be edited
before running:
